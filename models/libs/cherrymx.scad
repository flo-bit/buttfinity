  ...
  translate([0, 0, -3]) {
    ...
    color("darkGreen") {
      ...
      translate([0, 0, -4 - 5.3 - 5.5 - 2 / 2]) //steam + top + bottom (measured 5.5)
        cylinder(r=3.85 / 2 + extra, h=2, center=true);
      ...
      translate([4.95, 0, -4 - 5.3 - 5.5 - 2 / 2]) //steam + top + bottom (measured 5.5)
        cylinder(r=1.6 / 2 + extra, h=2, center=true);
...
module CherryMXWithCutouts(cutout_w = 16, cutout_h = 16, extra = 0.05, rounding = 0) {

  translate([0, 0, 4])
    CherryMX(extra);

  translate([0, 0, -8.5 + 10])
    cuboid([cutout_w, cutout_h, 20], rounding=rounding, edges="Z");

  translate([-5.2, 1.2, -21])
    cube([3, 3, 8]);

  translate([1.2, 3.5, -21])
    cube([3, 3, 8]);
}
